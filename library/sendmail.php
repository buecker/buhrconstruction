<?php
  ...
  define("MY_EMAIL", "mbuhr@buhrconstruction.com");
  define("EMAIL_SUBJECT", "A message sent from buhrconstruction.com");
  ...
  $fields_req =  array("name" => true, "phone" => true, "message" => true);
